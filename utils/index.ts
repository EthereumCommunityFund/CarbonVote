import type { PollOptionType } from '@/types';
...
export function getImagePathByCredential(credential: string): string {
  ...
  if (credential.includes('Whitelisted Addresses')) {
    return '/images/address_book.svg';
  }
  return '';
}

export const priorityPollIds = [
  '47f4d4e7-5085-4b02-8d4f-6ca38e6c6260',
  '197032b7-ff31-49ac-ae3d-49d7a9dea407',
...
/*export const convertOptionsToPollOptions = (options: Option[]): PollOptionType[] => {
  return options.map((option, index) => {
    ...
    return {
      ...
      totalWeight: option.votersCount,
