      ...
      <div className="flex flex-col justify-center">
        ...
        <div className="flex justify-end items-center mt-[10px]">
          {selectedEvents.length > 0 && (
            <button
              className={`${styles.auto_add_button} button-font-size mr-4`}
          ...
          <button className={styles.auto_add_button} onClick={addEthPoapEvents}>
            <span>Auto-add Ethereum Events</span>
