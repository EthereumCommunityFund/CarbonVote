...
import { ContractPollResultComponent } from '@/components/poll/result/EthPollResult';
...
import ConfirmationPopup from '@/components/poll/vote/ConfirmationPopup';
...
const PollPage = () => {
  ...
  const { data, isError, isSuccess, signMessage, signMessageAsync, reset } =
    useSignMessage();
  ...
  function renderCredentialDetails(credentialName: string) {
    switch (credentialName) {
      ...
      case CREDENTIALS.EthHoldingOffchain.name:
        return (
          <div className="flex flex-col gap-1">
            <div className="text-sm bg-[#f9f9f9] border border-[#ccc] rounded-md p-2.5 my-2.5 max-w-[320px]">
        ...
        <div className="bg-white flex flex-col gap-[30px] rounded-xl border border-black border-opacity-10 p-[10px] md:p-0">
            ...
            <div className={styles.voting_container}>
              {pollIsLive ? (
                ...
                <span>You Have Voted</span>
                  ...
                  <Label className={styles.container_header}>
                    Vote on Poll
                  </Label>
                  <div className={styles.nested_poll_header}>
                    <h4>
                      This is a nested poll. You can vote with multiple
                      credentials.
                    </h4>
                    ...
                    <div className={styles.eth_holding_container}>
                      <div>
                        ...
                        <h4>
                          ...
                          <span>
                            requires a <strong>zero-value transaction</strong>{' '}
                            from your wallet.
                          </span>
                        </h4>
                      </div>
                      <p>
                        Optionally, you can manually send a zero-value
                        transaction by pasting the address directly from your
                        wallet.
                      </p>
                      <div>
          ...
          <div className="gap-[25px] flex flex-col p-0 md:p-[10px] md:pb-[20px]">
            ...
            <PollResultComponent
              ...
              latestBlockNumber={0} // all the propertys are not used in this component, for pass type test
              endBlockNumber={0}
        ...
        <div className="bg-white rounded-lg border border-black border-opacity-10">
          ...
          <div className="w-full flex flex-col p-3.5 gap-3.5">
              ...
              <div className="flex flex-wrap items-center gap-1">
                <div className="flex px-2.5 py-1 gap-1 bg-black bg-opacity-5 rounded-xl">
                  ...
                  <Label className="text-black text-opacity-50 font-bold text-sm">
                    {credentialTable.length > 1
                      ? 'Nested poll'
                      : credentialTable[0]?.credential || ' '}
                  </Label>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              className="text-black text-opacity-50 font-bold text-sm cursor-pointer hover:opacity-80 flex items-center gap-2"
            >
              <span>
                Farcaster frame share link:{' '}
                {`${getHost()}/frames/${poll.id}`.substring(0, 20)}
                {`${getHost()}/frames/${poll.id}`.length > 20 ? '...' : ''}
              </span>
