    ...
    <div className="flex gap-20 px-20 pt-5 text-black w-full justify-center">
      <div className="flex flex-col gap-2.5">
        ...
        <div className="bg-white/40 p-2.5 flex flex-col gap-3.5">
          ...
          <Label>
            This vote requires a{" "}
            <Label className="font-bold">zero-value transaction</Label> from
            your wallet
          </Label>
          <div className="flex flex-col gap-2.5">
            {optionNames.map((optionName, index) => (
              <OptionButton
                ...
                isChecked={selectedOption === optionName}
              />
            ))}
          </div>
        </div>
      ...
      <div className="flex flex-col gap-10 w-96">
        ...
        {optionsData &&
          optionsData.map((option, index) => (
            <div
              key={index}
              className="flex flex-col bg-white rounded-xl gap-5"
            >
              <div className="px-2.5 py-5 border-b border-b-black/40 pb-5">
